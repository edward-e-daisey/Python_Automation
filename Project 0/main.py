...
# IN PROGRESS - Calculate total value of inventory per supplier
# total_value_per_supplier = df.groupby('Supplier')[['Inventory', 'Price']].agg({'Inventory': 'sum', 'Price': 'mean'}).eval('Inventory * Price').to_dict()
